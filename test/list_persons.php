...
<?php
     echo '<thead><tr><th>Fornavn</th><th>Efternavn</th><th>Email</th><th>Registreret</th></tr></thead><tbody>';
     while($row = mysql_fetch_array($result)) {
         echo '<tr>';
         echo '<td class="thai">'.$row['Fornavn'].'</td><td class="pronounce">'.$row['Efternavn'].'</td><td class="english">'.$row['Email'].'</td>'.'</td><td class="english">'.$row['date'].'</td>';
         echo '</tr>';
     }
     mysql_close($con);
?>
